<div class="add-provider-page">
    ...
    <div style="margin-bottom: var(--space-6);">
        <div style="display: flex; align-items: center; gap: var(--space-3); margin-bottom: var(--space-2);">
            ...
            <h2 style="margin: 0;">Add AI Provider</h2>
        </div>
        <p style="color: var(--color-text-tertiary); margin: 0;">Configure a new LLM provider connection</p>
    </div>

    <!-- Provider Form -->
    <div class="card" style="max-width: 640px;">
        <div class="card-body">
            <form method="POST" action="<?php echo htmlspecialchars($formAction ?? '/user/providers/save'); ?>" id="provider-form">
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint" id="provider-type-hint"></div>
                </div>
                ...
                <div class="form-group" id="api-key-group">
                    ...
                    <div style="position: relative;">
                        <input type="password" name="api_key" id="api_key" class="form-input" style="padding-right: 3rem;" placeholder="sk-..." value="<?php echo !empty($provider) ? '••••••••' : ''; ?>" autocomplete="new-password">
                    ...
                    <div class="form-hint" id="api-key-hint">Your API key is stored securely and encrypted</div>
                </div>
...
(function() {
    ...
    function onTypeChange() {
        ...
        if (selected && providerData[selected]) {
            ...
            if (!baseUrlInput.value || isDefaultBaseUrl(baseUrlInput.value)) {
            ...
            if (data.requiresApiKey) {
                ...
                apiKeyHint.textContent = 'Your API key is stored securely and encrypted';
    ...
    // Initialize if type is already set
    if (typeSelect.value) {
        onTypeChange();
    }
